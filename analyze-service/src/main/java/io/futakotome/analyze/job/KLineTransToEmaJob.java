...
public class KLineTransToEmaJob implements Job {
    ...
    public KLineTransToEmaJob(EmaMapper emaMapper, KLineMapper kLineMapper, TradeDateMapper tradeDateMapper) {
        this.ema = new Ema(emaMapper, kLineMapper, tradeDateMapper);
    }
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        if (Objects.nonNull(startDateTime) && Objects.nonNull(endDateTime)) {
            ema.calculate(toTableName, kTableName, startDateTime, endDateTime);
        } else {
            ...
            ema.calculate(toTableName, kTableName, todayStartTime, todayEndTime);
        }
    }
}
