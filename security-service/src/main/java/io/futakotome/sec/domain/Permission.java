...
public class Permission {
    ...
    public Permission(Long id, String name, Integer type, String method, Long menuId, LocalDateTime createTime, LocalDateTime modifyTime) {
        this.id = id;
        this.name = name;
        this.type = type;
        this.method = method;
    ...
    public static Permission dto2Permission(PermissionDto dto) {
        return new Permission(dto.getId(), dto.getName(), dto.getType(), dto.getMethod(), dto.getMenuId(),
                dto.getCreateTime(), dto.getModifyTime());
    }

    public static PermissionVo permission2Vo(Permission permission) {
        return new PermissionVo(permission.getId(), permission.getName(), permission.getType(), permission.getMethod(), permission.getMenuId(),
