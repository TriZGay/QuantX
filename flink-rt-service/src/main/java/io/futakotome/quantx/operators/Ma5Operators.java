...
public class Ma5Operators {
    ...
    public static class ToRow implements MapFunction<Tuple6<Integer, String, Integer, Double, LocalDateTime, LocalDateTime>, Row> {
        @Override
        public Row map(Tuple6<Integer, String, Integer, Double, LocalDateTime, LocalDateTime> ma5) throws Exception {
            return Row.of(ma5.f0, ma5.f1, ma5.f2, ma5.f3, DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").format(ma5.f4), DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").format(ma5.f5));
        }
    }

    public static int[] ma5Types() {
    ...
    public static TypeInformation<Tuple6<Integer, String, Integer, Double, LocalDateTime, LocalDateTime>> ma5TypeInformation() {
