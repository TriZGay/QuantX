...
@Component
@WebSocketMapping("/websocket/kl_history_detail")
public class HistoryKLDetailWsServerHandler
        extends AbstractWebSocketServerHandler implements WebSocketHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(HistoryKLDetailWsServerHandler.class);
    private final ObjectMapper objectMapper;
    private final ConcurrentHashMap<String, WebSocketSender> senderMap;

    public HistoryKLDetailWsServerHandler(ObjectMapper objectMapper, ConcurrentHashMap<String, WebSocketSender> senderMap) {
    ...
    public Mono<Void> handle(WebSocketSession session) {
        ...
        //todo 定点推送?
        String id = queryMap.getOrDefault("id", KLINE_HISTORY_DETAIL_TAG);
