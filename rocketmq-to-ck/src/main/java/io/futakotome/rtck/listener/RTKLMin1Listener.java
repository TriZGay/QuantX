...
@Component
@RocketMQMessageListener(consumerGroup = MessageCommon.RT_KL_MIN_1_CONSUMER_GROUP, topic = MessageCommon.RT_KL_MIN_1_TOPIC, consumeMode = ConsumeMode.ORDERLY)
public class RTKLMin1Listener extends AbstractKLineListener implements RocketMQListener<RTKLMessage> {
    ...
    public RTKLMin1Listener(RTKLMapper mapper, ConcurrentHashMap<String, WebSocketSender> senderMap) {
        this.mapper = mapper;
