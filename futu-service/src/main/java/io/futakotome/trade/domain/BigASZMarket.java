...
public class BigASZMarket implements
    ...
    public void sendPlateInfoRequest(StockDtoMapper stockMapper) {
        List<StockDto> hkStocks = stockMapper.selectList(Wrappers.<StockDto>query()
                ...
                .and(stockDtoQueryWrapper -> stockDtoQueryWrapper.eq("market", QotCommon.QotMarket.QotMarket_CNSZ_Security_VALUE)));
        ...
        while (stockSize > requestStockLimit) {
            ...
            requestCount += 1;
            LOGGER.info("SeqNo:" + seqNo + "大A深圳市场请求板块信息:" + request.toString() + "count:" + request);
    ...
    public void sendStockInfoRequest(PlateDtoMapper plateDtoMapper) {
        List<PlateDto> hkAllPlates = plateDtoMapper.searchByMarketEquals(QotCommon.QotMarket.QotMarket_CNSZ_Security_VALUE);
        for (int i = 0; i < hkAllPlates.size(); i++) {
            ...
            LOGGER.info("SeqNo:" + seqNo + "大A深圳市场请求股票信息:" + request.toString());
        ...
        try {
            LOGGER.info("大A深圳市场请求股票信息结束.sleep....");
            Thread.sleep(30000L);
        } catch (InterruptedException e) {
            LOGGER.error("sleep失败!", e);
        }
    ...
    public void sendStaticInfoRequest() {
        ...
        LOGGER.info("SeqNo:" + seqNo + "大A深圳市场请求静态信息:" + request.toString());
    }
    ...
    public void sendIpoInfoRequest() {
        ...
        LOGGER.info("SeqNo:" + seqNo + "大A深圳市场请求IPO信息:" + request.toString());
    }
    ...
    public void sendTradeDateRequest() {
        ...
        LOGGER.info("SeqNo:" + seqNo + "大A深圳市场请求交易日信息:" + request.toString());
    }
}
