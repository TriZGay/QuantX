...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = HeatMapDataWsMessage.class, name = "HEAT_MAP_DATA"),
        ...
        @JsonSubTypes.Type(value = EarningsCalendarWsMessage.class, name = "EARNINGS_CALENDAR"),
        ...
        @JsonSubTypes.Type(value = IndicatorCalcWsMessage.class, name = "INDICATOR_CALC"),
        @JsonSubTypes.Type(value = IndicatorCalcResultWsMessage.class, name = "INDICATOR_CALC_RESULT"),
