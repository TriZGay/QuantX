...
public class ReactiveWebSocketBasicQuoteServerHandler
    ...
    public ReactiveWebSocketBasicQuoteServerHandler(ConcurrentHashMap<String, WebSocketSender> sendMap, ObjectMapper objectMapper) {
    ...
    public Mono<Void> handle(WebSocketSession session) {
        ...
        //todo 定点推送?
        String id = queryMap.getOrDefault("id", BASIC_QUOTE_TAG);
