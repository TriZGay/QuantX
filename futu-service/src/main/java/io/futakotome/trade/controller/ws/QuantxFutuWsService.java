...
public class QuantxFutuWsService {
    ...
    public void sendTopMoversRank(TopMoversRankWsMessage message) {
    ...
    public void sendMarcoIndiesHistory(MarcoIndiesHistoryWsMessage message) {
        this.template.convertAndSend(BROKER_PREFIX + MARCO_INDIES_HISTORY, message);
    }

    public void sendDividendRank(DividendRankWsMessage message) {
        this.template.convertAndSend(BROKER_PREFIX + DIVIDEND_RANK, message);
    }

    public void sendDividendRank(EarningsCalendarWsMessage message) {
    ...
    public void sendEconomicCalendar(EconomicCalendarWsMessage message) {
        this.template.convertAndSend(BROKER_PREFIX + ECONOMIC_CALENDAR, message);
    }

    public void sendEarningsBeatRank(EarningsBeatRankWsMessage message) {
        this.template.convertAndSend(BROKER_PREFIX + EARNINGS_BEAT_RANK, message);
    }

    public void sendIndicatorList(IndicatorListWsMessage message) {
        this.template.convertAndSend(BROKER_PREFIX + INDICTOR_LIST, message);
    }

    public void sendIndicatorCalcReq(IndicatorCalcWsMessage message) {
